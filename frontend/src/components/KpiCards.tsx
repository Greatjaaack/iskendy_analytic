 ...
 *  Все три значения — из одного источника (REV_GROSS, `/api/revenue`), поэтому
 *  согласованы между собой. Разрез по каналам (доставка/зал) вынесен в отдельный
 *  дашборд «Доставка» — там всё из OLAP и сходится внутри себя, без смешения метрик. */
