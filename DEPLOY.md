...
Копится с 26.08: **22 коммита аналитики** (`dd745c2` → `d092276`; свежие с кодом — `3409676` адаптер
Saby, `1c8a1e4` журнал и проверка сессии iiko, `07cd90c` фронт: «сегодня» по Москве и
чистка, `d092276` мёртвый код бэкенда и общий `daterange`) и **10 коммитов табло**
...
```bash
cd /root/dashboards && git pull && git log --oneline -1     # не старше d092276
...
- [ ] Коммит на сервере не старше `d092276`
